...
export function DomainMutes () {
  return import(/* webpackChunkName: "flavours/glitch/async/domain_mutes" */'../../domain_mutes');
}

export function DomainMuteModal () {
  return import(/* webpackChunkName: "flavours/glitch/async/domain_mute_modal" */'flavours/glitch/features/ui/components/domain_mute_modal');
}
