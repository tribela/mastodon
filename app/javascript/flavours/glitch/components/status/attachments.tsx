...
const MediaGallery = lazy<TMediaGallery>(
  () => import('@/flavours/glitch/components/media_gallery'),
);
const Audio = lazy(() => import('@/flavours/glitch/features/audio'));
const Video = lazy(() => import('@/flavours/glitch/features/video'));
